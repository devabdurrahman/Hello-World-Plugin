<?php
/**
* Plugin Name: Hello Earth Plugin
* Description: This is our first plugin, which creates some information to admin dashboard as well as at admin notice
* Author: Abdur Rahman
* Version: 1.0
...
function hw_show_information_message(){
	echo "<div class='notice notice-info is-dismissible'><p>Hello, I am an information message</p></div>";
}
...
function hw_custom_admin_widget(){
	echo "This is hello world custom widget";
}